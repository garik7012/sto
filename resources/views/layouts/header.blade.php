        ...
        <div class="header-page__nav">
            <div class="nav top-nav">
                <ul class="top-nav__list">
                    ...
                    <li class="top-nav__item">
                        <a href="" class="top-nav__link">Услуги</a>
                    </li>

                    <li class="top-nav__item">
                        <a href="" class="top-nav__link">вакансии</a>
                    </li>

                    <li class="top-nav__item">
                        <a href="" class="top-nav__link">Отзывы</a>
                    </li>

                    <li class="top-nav__item">
                        <a href="" class="top-nav__link">Фото</a>
                    </li>

                    <li class="top-nav__item">
                        <a href="" class="top-nav__link">дополнительные услуги</a>
                    </li>
                </ul>
            </div>
        </div>
                ...
                <div class="number-phone__left-wrap">
                    ...
                    <div class="number-phone__item">
                        <div class="head-number">
                            ...
                            <a href="tel:0672195157" class="head-number__text">
                                (067)219-51-57
                            </a>
                        </div>
                    </div>
